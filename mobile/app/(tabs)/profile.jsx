import { Text, View, Alert, FlatList, TouchableOpacity, ActivityIndicator, RefreshControl } from 'react-native'
  ...
  const renderBookItem = ({item}) =>(
    <View style={styles.bookItem}>
      ...
      <View style={styles.bookInfo}>
        ...
        <Text style={styles.bookCaption} numberOfLine={2}>{item.caption}</Text>
